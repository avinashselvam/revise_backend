...
def get_questions_and_evaluations_from_open_ai(topic, difficulty, submission):
    ...
    prompt = f"You're currently helping me revise {topic} at increasing levels of difficulty from 1 to 4. Below are the previous 5 questions that you asked me and my answers for them {submission}. Evaluate them. If correct, no explanation needed. If wrong, provide reason_if_wrong. If unattempted, provide answer in explanation. And then ask me 5 more questions from the same topic but with increased difficulty level of {difficulty}. response should be in json format."
